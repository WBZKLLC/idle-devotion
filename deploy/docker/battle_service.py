"""Battle Service - Standalone microservice entry point"""
...
app = FastAPI(
    title="Divine Heroes - Battle Service",
    description="Arena PvP and Abyss combat microservice",
    version="1.0.0",
    lifespan=lifespan
)
