...
const styles = StyleSheet.create({
  ...
  heroResultCard: { width: 100, backgroundColor: COLORS.navy.medium, borderRadius: 12, borderWidth: 2, overflow: 'hidden', padding: 12, alignItems: 'center', marginRight: 12 },
  ...
  heroName: { color: COLORS.cream.soft, fontSize: 11, fontWeight: '600', textAlign: 'center', marginTop: 8 },
